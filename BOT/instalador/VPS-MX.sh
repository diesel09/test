...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/lacasitamx/rex/master/BOT/control-IP")
...
rm -rf lista-arq
  ...
  ### INTALAR VERCION DE SCRIPT
    v1=$(curl -sSL "https://raw.githubusercontent.com/lacasitamx/VPSMX/master/Vercion")
...
wget -O /bin/monitor.sh https://raw.githubusercontent.com/lacasitamx/VPSMX/master/Monitor-Service/monitor.sh &> /dev/null
